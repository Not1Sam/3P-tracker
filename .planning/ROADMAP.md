...
- [ ] **Phase 3: History & Entry Management** - Calendar/list views, edit/delete entries, entry detail screens
- [ ] **Phase 4: Navigation & Thematic UI** - Tab navigation, brown/yellow/pink theme, core UI components, playful vibe
- [ ] **Phase 5: Auth & Supabase Backend** - Self-hosted Supabase, email/Google/Apple sign-in, biometric lock, monthly sync
...
Plans:
- [ ] 04-01: Tab navigation — Expo Router tabs, custom tab bar with themed icons
- [ ] 04-02: Design system — color palette, typography, spacing, shared components
- [ ] 04-03: Theme system — Playful vs Clinical mode toggle, persistent preference
...
Plans:
- [ ] 05-01: Self-hosted Supabase setup — Docker Compose, database schema, RLS policies, runbook
- [ ] 05-02: Email/password auth — registration, login, session management, SecureStore tokens
- [ ] 05-03: OAuth providers — Google via expo-auth-session, Apple via expo-apple-authentication
- [ ] 05-04: Biometric app lock — expo-secure-store biometric, app lock screen, session persistence
- [ ] 05-05: Monthly sync service — poop/piss summary aggregation, encrypted batch upload, sync state tracking
...
Plans:
- [ ] 06-01: User profiles — username creation, avatar selection, profile screen
- [ ] 06-02: Friend system — username search, friend requests, accept/reject, remove friends
- [ ] 06-03: Invite system — QR code generation (react-native-qrcode-svg), invite links, join via link
...
| LOG-10 | Phase 3 | Pending |
| LOG-11 | Phase 3 | Pending |
